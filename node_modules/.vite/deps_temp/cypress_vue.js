...
function watchPostEffect(effect2, options2) {
  return doWatch(effect2, null, true ? Object.assign(Object.assign({}, options2), { flush: "post" }) : { flush: "post" });
}
function watchSyncEffect(effect2, options2) {
  return doWatch(effect2, null, true ? Object.assign(Object.assign({}, options2), { flush: "sync" }) : { flush: "sync" });
}
...
var defineSSRCustomElement = (options2) => {
...
var toHandlerKey2 = cacheStringFunction$2((str) => str ? `on${capitalize$1(str)}` : ``);
    ...
    if (mode === 0 || mode === 1) {
      if (!context.inVPre && startsWith(s, context.options.delimiters[0])) {
        ...
        if (s.length === 1) {
          ...
          if (isCompatEnabled$1("COMPILER_NATIVE_TEMPLATE", context) && node && node.tag === "template" && !node.props.some((p2) => p2.type === 7 && isSpecialTemplateDirective(p2.name))) {
...
var isSpecialTemplateDirective = makeMap2(`if,else,else-if,for,slot`);
  ...
  switch (node.type) {
    ...
    case 8:
      ...
      for (let i = 0; i < node.children.length; i++) {
        ...
        if (isString2(child) || isSymbol2(child)) {
          continue;
        }
...
function createStructuralDirectiveTransform(name, fn) {
  const matches3 = isString2(name) ? (n) => n === name : (n) => name.test(n);
  return (node, context) => {
    if (node.type === 1) {
      const { props } = node;
...
function genNodeListAsArray(nodes, context) {
  const multilines = nodes.length > 3 || nodes.some((n) => isArray2(n) || !isText$1(n));
  context.push(`[`);
...
function buildProps(node, context, props = node.props, ssr = false) {
  ...
  const analyzePatchFlag = ({ key, value }) => {
    if (isStaticExp(key)) {
      ...
      const isEventHandler = isOn2(name);
      if (!isComponent2 && isEventHandler && name.toLowerCase() !== "onclick" && name !== "onUpdate:modelValue" && !isReservedProp2(name)) {
                ...
                const hasOverridableKeys = mergeArgs.some((arg2) => {
                  if (arg2.type === 15) {
                    return arg2.properties.some(({ key }) => {
                      ...
                      return key.content !== "class" && key.content !== "style" && !isOn2(key.content);
                    });
                  } else {
                    return true;
                  }
...
function dedupeProperties(properties) {
  ...
  for (let i = 0; i < properties.length; i++) {
    ...
    if (existing) {
      if (name === "style" || name === "class" || isOn2(name)) {
...
var transformOn$1 = (dir, node, context, augmentor) => {
  ...
  if (arg.type === 4) {
    if (arg.isStatic) {
      ...
      eventName = createSimpleExpression(toHandlerKey2(camelize$2(rawName)), true, arg.loc);
    } else {
...
function compile3(template, options2 = {}) {
...
var Pluggable = function() {
  ...
  Pluggable2.prototype.extend = function(instance) {
    var invokeSetup = function(_a2) {
      var handler = _a2.handler, options2 = _a2.options;
      return handler(instance, options2);
    };
    var bindProperty = function(_a2) {
...
function mergeStubs(target, source) {
  if (source.stubs) {
    if (Array.isArray(source.stubs)) {
      ...
      for (var _i = 0, _a2 = Object.entries(source.stubs); _i < _a2.length; _i++) {
...
function mergeGlobalProperties(mountGlobal) {
  ...
  var stubs = {};
  var configGlobal = (_a2 = config === null || config === void 0 ? void 0 : config.global) !== null && _a2 !== void 0 ? _a2 : {};
...
function isClassComponent2(component) {
...
function isFunctionalComponent(component) {
  return typeof component === "function" && !isClassComponent2(component);
}
...
function textContent(element) {
  var _a2, _b;
  return element.nodeType !== Node.COMMENT_NODE ? (_b = (_a2 = element.textContent) === null || _a2 === void 0 ? void 0 : _a2.trim()) !== null && _b !== void 0 ? _b : "" : "";
}
...
function generateModifiers(modifiers, isOnClick) {
  ...
  for (var i = 0; i < modifiers.length; i++) {
    ...
    if (systemKeyModifiers.includes(modifier) || mouseKeyModifiers.includes(modifier) && isOnClick) {
      systemModifiers2.push(modifier);
    } else {
      keyModifiers.push(modifier);
    }
  }
  return {
    keyModifiers,
    systemModifiers: systemModifiers2
  };
}
function getEventProperties(eventParams) {
  var modifiers = eventParams.modifiers, _a2 = eventParams.options, options2 = _a2 === void 0 ? {} : _a2, eventType = eventParams.eventType;
  var isOnClick = eventType === "click";
  var _b = generateModifiers(modifiers, isOnClick), keyModifiers = _b.keyModifiers, systemModifiers2 = _b.systemModifiers;
  if (isOnClick) {
    if (systemModifiers2.includes("right")) {
      eventType = "contextmenu";
      options2.button = 2;
    } else if (systemModifiers2.includes("middle")) {
      eventType = "mouseup";
      options2.button = 1;
    }
  }
  ...
  var systemModifiersMeta = systemModifiers2.reduce(function(all, key) {
...
function createEvent(eventParams) {
  var _a2 = getEventProperties(eventParams), eventProperties = _a2.eventProperties, meta = _a2.meta, eventType = _a2.eventType;
  ...
  return new SupportedEventInterface(eventType, eventProperties);
}
function createDOMEvent(eventString, options2) {
  var _a2 = eventString.split("."), eventType = _a2[0], modifiers = _a2.slice(1);
  var eventParams = {
    eventType,
    modifiers,
    options: options2
...
var camelizeRE2 = /-(\w)/g;
var camelize2 = cacheStringFunction2(function(str) {
...
function isCompatEnabled(key) {
  var _a2, _b;
  return (_b = (_a2 = compatUtils) === null || _a2 === void 0 ? void 0 : _a2.isCompatEnabled(key)) !== null && _b !== void 0 ? _b : false;
}
function isLegacyExtendedComponent(component) {
  if (!isCompatEnabled("GLOBAL_EXTEND") || typeof component !== "function") {
    return false;
  }
  return hasOwnProperty2(component, "super") && component.super.extend({}).super === component.super;
}
...
function isLegacyFunctionalComponent(component) {
  return Boolean(component && typeof component === "object" && hasOwnProperty2(component, "functional") && component.functional);
}
var getComponentNameInSetup = function(instance, type) {
  return Object.keys((instance === null || instance === void 0 ? void 0 : instance.setupState) || {}).find(function(key) {
    var _a2;
    return ((_a2 = Object.getOwnPropertyDescriptor(instance.setupState, key)) === null || _a2 === void 0 ? void 0 : _a2.value) === type;
  });
};
...
var getComponentName2 = function(instance, type) {
...
var registerStub = function(_a2) {
  var source = _a2.source, stub = _a2.stub, originalStub = _a2.originalStub;
  stubsMap.set(stub, { source, originalStub });
};
var getOriginalVNodeTypeFromStub = function(type) {
  var _a2;
  return (_a2 = stubsMap.get(type)) === null || _a2 === void 0 ? void 0 : _a2.source;
};
var getOriginalStubFromSpecializedStub = function(type) {
  var _a2;
  return (_a2 = stubsMap.get(type)) === null || _a2 === void 0 ? void 0 : _a2.originalStub;
};
...
var stringifySymbols = function(props) {
  ...
  return Object.keys($props).reduce(function(acc, key) {
    ...
    if (typeof $props[key] === "symbol") {
      return __assign(__assign({}, acc), (_a2 = {}, _a2[key] = (_c = $props[key]) === null || _c === void 0 ? void 0 : _c.toString(), _a2));
    }
    return __assign(__assign({}, acc), (_b = {}, _b[key] = $props[key], _b));
  }, {});
};
var createStub = function(_a2) {
  var name = _a2.name, type = _a2.type, renderStubDefaultSlot = _a2.renderStubDefaultSlot;
  var anonName = "anonymous-stub";
  var tag = name ? "".concat(hyphenate2(name), "-stub") : anonName;
  var propsDeclaration = type ? unwrapLegacyVueExtendComponent(type).props || {} : {};
  return defineComponent({
    name: name || anonName,
    props: propsDeclaration,
    setup: function(props, _a3) {
      var slots = _a3.slots;
      return function() {
...
var resolveComponentStubByName = function(componentName, stubs) {
  ...
  for (var _i = 0, _a2 = Object.entries(stubs); _i < _a2.length; _i++) {
    var _b = _a2[_i], stubKey = _b[0], value = _b[1];
...
function stubComponents(stubs, shallow, renderStubDefaultSlot) {
  ...
  transformVNodeArgs(function(args, instance) {
    ...
    if (type === TransitionGroup && "transition-group" in stubs && stubs["transition-group"]) {
      return [
        createStub({
    ...
    if (isComponent(type) || isFunctionalComponent(type)) {
      ...
      var componentName = getComponentName2(instance, type);
      var stub = null;
      var name_1 = null;
      if (registeredName) {
...
function matches2(node, rawSelector) {
  ...
  if (typeof selector === "string") {
    return (_b = (_a2 = node.el) === null || _a2 === void 0 ? void 0 : _a2.matches) === null || _b === void 0 ? void 0 : _b.call(_a2, selector);
  }
  ...
  var componentName;
  componentName = getComponentName2(node.component, nodeType);
...
function find(root, selector) {
  ...
  if (typeof selector === "string") {
    matchingVNodes = matchingVNodes.filter(function(vnode) {
      var _a2;
      return ((_a2 = vnode.component.parent) === null || _a2 === void 0 ? void 0 : _a2.vnode.el) !== vnode.el;
    });
  }
...
function isStyleVisible(element) {
  ...
  var _a2 = getComputedStyle(element), display = _a2.display, visibility = _a2.visibility, opacity = _a2.opacity;
...
InputScanner$3.prototype.__match = function(pattern2, index) {
...
InputScanner$3.prototype.test = function(pattern2, index) {
  index = index || 0;
  index += this.__position;
  if (index >= 0 && index < this.__input_length) {
...
InputScanner$3.prototype.testChar = function(pattern2, index) {
...
var Options$6 = options$3.Options;
...
var Options$3 = options$1.Options;
...
var VueWrapper = function(_super) {
  ...
  VueWrapper2.prototype.attachNativeEventListener = function() {
    ...
    for (var _i = 0, _a2 = Object.keys(domEvents); _i < _a2.length; _i++) {
      var eventName = _a2[_i];
      _loop_1(eventName);
    }
  };
...
function processSlot(source, Vue$1) {
  ...
  var code = compile3("<transition>".concat(template, "</transition>"), {
    mode: "function",
...
function getInstanceOptions(options2) {
  ...
  for (var _i = 0, _a2 = Object.keys(options2); _i < _a2.length; _i++) {
    var key = _a2[_i];
...
function mount$1(inputComponent, options2) {
  ...
  if (isFunctionalComponent(originalComponent) || isLegacyFunctionalComponent(originalComponent)) {
    ...
    }, props: originalComponent.props || {}, setup: function(_, _a3) {
      var attrs = _a3.attrs, slots2 = _a3.slots;
      return function() {
        return h(originalComponent, attrs, slots2);
      };
    } }, instanceOptions));
  ...
  var slots = (options2 === null || options2 === void 0 ? void 0 : options2.slots) && Object.entries(options2.slots).reduce(function(acc, _a3) {
    var name = _a3[0], slot = _a3[1];
  ...
  var props = reactive(__assign(__assign(__assign(__assign({}, options2 === null || options2 === void 0 ? void 0 : options2.attrs), options2 === null || options2 === void 0 ? void 0 : options2.propsData), options2 === null || options2 === void 0 ? void 0 : options2.props), { ref: MOUNT_COMPONENT_REF }));
  ...
  var setProps = function(newProps) {
    for (var _i2 = 0, _a3 = Object.entries(newProps); _i2 < _a3.length; _i2++) {
      var _b2 = _a3[_i2], k2 = _b2[0], v2 = _b2[1];
      props[k2] = v2;
    }
    return vm.$nextTick();
  };
  ...
  if (global2 === null || global2 === void 0 ? void 0 : global2.mocks) {
    var mixin = {
      beforeCreate: function() {
        for (var _i2 = 0, _a3 = Object.entries(global2.mocks); _i2 < _a3.length; _i2++) {
          var _b2 = _a3[_i2], k2 = _b2[0], v2 = _b2[1];
          this[k2] = v2;
        }
      }
  ...
  if (global2.config) {
    for (var _i = 0, _a2 = Object.entries(global2.config); _i < _a2.length; _i++) {
      var _b = _a2[_i], k = _b[0], v = _b[1];
      app.config[k] = v;
    }
  }
  ...
  stubComponents(global2.stubs, options2 === null || options2 === void 0 ? void 0 : options2.shallow, global2 === null || global2 === void 0 ? void 0 : global2.renderStubDefaultSlot);
  if (global2 === null || global2 === void 0 ? void 0 : global2.stubs) {
    for (var _o = 0, _p = Object.keys(global2.stubs); _o < _p.length; _o++) {
      var name_1 = _p[_o];
...
var RouterLinkStub = defineComponent({
  ...
  render: function() {
    var _this = this;
    var _a2, _b;
    var route = computed2(function() {
      return defaultRoute;
    });
    var children = (_b = (_a2 = this.$slots) === null || _a2 === void 0 ? void 0 : _a2.default) === null || _b === void 0 ? void 0 : _b.call(_a2, {
      route,
      href: computed2(function() {
        return route.value.href;
      }),
      isActive: computed2(function() {
        return false;
      }),
      isExactActive: computed2(function() {
        return false;
      }),
      navigate: function() {
...
Cypress.on("run:start", function() {
  ...
  Cypress.on("test:before:run", function() {
    var _a2;
    (_a2 = Cypress.vueWrapper) === null || _a2 === void 0 ? void 0 : _a2.unmount();
...
function mount(componentOptions, options2) {
  ...
  return cy.then(function() {
    ...
    var document2 = cy.state("document");
    var el = getContainerEl();
    injectStylesBeforeElement(options2, document2, el);
    if (options2.extensions) {
      options2.extensions.plugins = (_a2 = []) === null || _a2 === void 0 ? void 0 : _a2.concat(options2.extensions.plugins || [], options2.extensions.use || []);
      options2.extensions.mixins = (_b = []) === null || _b === void 0 ? void 0 : _b.concat(options2.extensions.mixins || [], options2.extensions.mixin || []);
      options2.global = __assign$1(__assign$1({}, options2.extensions), options2.global);
    }
    var componentNode = document2.createElement("div");
    componentNode.id = "__cy_vue_root";
    el.append(componentNode);
    var wrapper = VTUmount(componentOptions, __assign$1({ attachTo: componentNode }, options2));
    Cypress.vueWrapper = wrapper;
    Cypress.vue = wrapper.vm;
    return cy.wrap(wrapper, { log: false }).wait(1, { log: false }).then(function() {
      if (logInstance) {
...
function getComponentDisplayName(componentOptions) {
  ...
  if (componentOptions.__file) {
    ...
    var fileName = (_a2 = filepathSplit[filepathSplit.length - 1]) !== null && _a2 !== void 0 ? _a2 : DEFAULT_COMP_NAME;
